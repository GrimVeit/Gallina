...
public class MenuGlobalStateMachine : IControlGlobalStateMachine
{
        ...
        SwipeClickDescriptionPresenter swipeClickDescriptionPresenter)
    {
        ...
        states[typeof(EndPackSpin_MenuScene)] = new EndPackSpin_MenuScene(this, swipeAnimationPresenter, clickPresenter);
        ...
        states[typeof(EndOpenCards_MenuScene)] = new EndOpenCards_MenuScene(this, swipeAnimationPresenter, clickPresenter);
